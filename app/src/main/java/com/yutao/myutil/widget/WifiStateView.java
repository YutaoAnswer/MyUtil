package com.yutao.myutil.widget;
...
import com.yutao.myutil.R;

import java.lang.ref.WeakReference;

/**
 * custom wifi signal indicates view
 * Created by YutaoAnswer on 2019/3/22.
 */
public class WifiStateView extends ImageView {
    ...
    private static class WifiHandler extends Handler {
        ...
        WifiHandler(WifiStateView view) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case LEVEL_0:
                    view.setImageResource(R.drawable.ic_wifi1);
                    break;
                case LEVEL_1:
                    view.setImageResource(R.drawable.ic_wifi2);
                    break;
                case LEVEL_2:
                    view.setImageResource(R.drawable.ic_wifi3);
                    break;
                case LEVEL_3:
                    view.setImageResource(R.drawable.ic_wifi4);
                    break;
                case LEVEL_NONE:
                    view.setImageResource(R.drawable.ic_wifi0);
                    break;
                default:
                    break;
            }
                ...
                switch (action) {
                    ...
                    case ConnectivityManager.CONNECTIVITY_ACTION:
                        ...
                        if (netInfo == null || netInfo.getType() != ConnectivityManager.TYPE_WIFI) {
                            mWifiHandler.sendEmptyMessage(LEVEL_NONE);
                        } else if (netInfo.getType() == ConnectivityManager.TYPE_WIFI && !netInfo.isConnected()) {
                            mWifiHandler.sendEmptyMessage(LEVEL_NONE);
                        }
                        break;
